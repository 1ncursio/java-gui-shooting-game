        ...
        while(loop) {
            ...
            switch (screen) {
                ...
                case GAME:
                    ...
                    if(Keyboard.isKeyPressed(KeyEvent.VK_RIGHT)&&playerX<470) playerX+=10;
                    if(Keyboard.isKeyPressed(KeyEvent.VK_UP)&&playerY>30) playerY-=10;
                    if(Keyboard.isKeyPressed(KeyEvent.VK_DOWN)&&playerY<450) playerY+=10;
